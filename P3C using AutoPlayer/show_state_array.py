...
def initialize_tk(width=300, height=300, title='State Display Window', cho_fac=''):
    global root
    global STATE_WINDOW
    root = tk.Tk()
    root.title(title)
...
def make_modalW(current_state=[], year=2018, cho_fac=''):
    ...
    print("quit the election screen[q]: ", end="")
    time.sleep(0.5)
    print("q")
    time.sleep(0.3)
    ...
    for i in range(len(media_companies)):
        ...
        if (media_companies[i] == "Cable News Network (CNN)"):
            ...
            if (choice_policy == "immigration forward" and \
                ...
                STATE_WINDOW.canvas.create_text(1540, 200, font=("Courier New", 18), width=250,
                                                text=" The people have been supportive of it as shown by a " + choice1,
                                                fill='white', tag='media_info')

            elif (choice_policy == "immigration backward" and \
                  (choice_faction == "liberal" or choice_faction == "socialist")):
                STATE_WINDOW.canvas.create_text(1540, 200, font=("Courier New", 18), width=250,
                                                text=" The people have been against of it as shown by a " + choice2,
                                                fill='white', tag='media_info')

            elif (choice_policy == "immigration forward" and \
                  (choice_faction == "conservative" or choice_faction == "populist")):
                STATE_WINDOW.canvas.create_text(1540, 200, font=("Courier New", 18), width=250,
                                                text=" Though in the short run the president and the country needs to make sacrifice," \
                  ...
                  (choice_faction == "conservative" or choice_faction == "populist")):
                STATE_WINDOW.canvas.create_text(1540, 200, font=("Courier New", 18), width=250,
                                                text=" Though in the short run the president and the country can benefit from this reform, " \
            ...
            if (choice_policy == "immigration forward" and \
                    (choice_faction == "liberal" or choice_faction == "socialist")):
                STATE_WINDOW.canvas.create_text(1540, 500, font=("Courier New", 18), width=250,
                                                text=" Though in the short run the president and the country can benefit from this reform, " \
                                                     + "we believe in the long run it can lead to serious problems in the country.",
                                                fill='white', tag='media_info')
            ...
            if (choice_policy == "immigration forward" and \
                    (choice_faction == "liberal" or choice_faction == "socialist")):
                STATE_WINDOW.canvas.create_text(1540, 800, font=("Courier New", 18), width=250,
                                                text=" The people have been supportive of it as shown by a " + choice3,
                                                fill='white', tag='media_info')

            elif (choice_policy == "immigration backward" and \
                  (choice_faction == "liberal" or choice_faction == "socialist")):
                STATE_WINDOW.canvas.create_text(1540, 800, font=("Courier New", 18), width=250,
                                                text=" The people have been against of it as shown by a " + choice4,
                                                fill='white', tag='media_info')
